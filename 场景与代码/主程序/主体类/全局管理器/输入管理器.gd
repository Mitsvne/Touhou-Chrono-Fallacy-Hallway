...
func _initialize_default_mappings() -> void:
	...
	DEFAULT_MAPPINGS = {
		...
		"attack":     [key.call(KEY_J), mouse.call(MOUSE_BUTTON_LEFT)],
		"dash":       [key.call(KEY_L), mouse.call(MOUSE_BUTTON_RIGHT)],
		"defense":    [key.call(KEY_K), key.call(KEY_SHIFT)],
		"skill":      [key.call(KEY_U), key.call(KEY_E)],
		"ultimate":   [key.call(KEY_I), key.call(KEY_Q)],
		"assist":     [key.call(KEY_O), key.call(KEY_R)],
